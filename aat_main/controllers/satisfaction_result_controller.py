...
def assessment_review_results(id):
    ...
    sr_raws = [review.statement_response_map for review in reviews]
    # print(sr_raws)
    statement_counts = DBHelper.decode(sr_raws, responses)
    # TODO maybe add mentimeter-style visualtion (including mean?)
    # for statement in statement_counts:
    #     statement['mean'] = mean()
